...

    {
        ...
        public bool AddProduct(Product pr)
        {
            ...
            try
            {
                ...
                DbParameter p1 = new MySqlParameter { 
                ...
                DbParameter p2 = new MySqlParameter
                {
                ...
                plist.Add(p2);
                DbParameter p3 = new MySqlParameter
                {
                    ParameterName = "@Price",
                ...
                plist.Add(p3);
                DbParameter p4 = new MySqlParameter
                {
                ...
                plist.Add(p4);
                DbParameter p5 = new MySqlParameter
                {
                ...
                plist.Add(p5);
                DbParameter p6 = new MySqlParameter
                {
                ...
                plist.Add(p6);
                DbParameter p7 = new MySqlParameter
                {
                ...
                plist.Add(p7);
                DbParameter p8 = new MySqlParameter
                {
                    ParameterName =
               "@Discontinued",
                    MySqlDbType = MySqlDbType.Bit,
        ...
        public bool UpdateProduct(Product pr)
        {
            ...
            try
            {
                string sql = "UPDATE Products SET ProductName = @ProductName,Description = @Description,Price = @Price,"
                    + "Description=@Description,StockLevel=@StockLevel,PColor=@PColor,"
                    + "OnSale=@OnSale,Discontinued=@Discontinued WHERE ProductId = @ProductId";
                List<DbParameter> plist = new List<DbParameter>();
                DbParameter p0 = new MySqlParameter
                {
                    ParameterName = "@ProductId",
                    MySqlDbType = MySqlDbType.Int32,
                    Value = pr.ProductId
